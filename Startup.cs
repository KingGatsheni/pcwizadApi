...
namespace backendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ProductsData.IProductsData, ProductsData.SqlProductData>();
            services.AddTransient<UserInfoData.IUserInfoData, UserInfoData.SqlUserInfoData>();
